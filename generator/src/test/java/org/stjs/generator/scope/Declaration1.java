...
import static org.stjs.generator.scope.Bean1.parentPrivate;
import static org.stjs.generator.scope.Bean1.stat;
...
public class Declaration1 extends ParentDeclaration1 {
	...
	public void x(int param) {
		...
		int exp2 = org.stjs.generator.scope.Bean1.full;
		new Runnable() {
			int type = 1;
