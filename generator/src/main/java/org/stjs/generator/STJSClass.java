...
public class STJSClass implements ClassWithJavascript {
	...
	public void store() {
		...
		try {
			propertiesWriter = new OutputStreamWriter(new FileOutputStream(getStjsPropertiesFile()), Charsets.UTF_8);
			System.out.println("STORING PROPS " + properties + " TO :" + getStjsPropertiesFile());
