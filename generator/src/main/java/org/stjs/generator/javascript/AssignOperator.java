...
public enum AssignOperator {
	...
	// logical
	AND_ASSIGNMENT(Kind.AND_ASSIGNMENT, Token.ASSIGN_BITAND, BinaryOperator.AND), //
	XOR_ASSIGNMENT(Kind.XOR_ASSIGNMENT, Token.ASSIGN_BITXOR, BinaryOperator.XOR), //
	OR_ASSIGNMENT(Kind.OR_ASSIGNMENT, Token.ASSIGN_BITOR, BinaryOperator.OR), //

	INSTANCE_OF(Kind.INSTANCE_OF, Token.INSTANCEOF, null);
