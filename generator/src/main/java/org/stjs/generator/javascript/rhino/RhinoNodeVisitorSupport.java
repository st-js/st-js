...
public class RhinoNodeVisitorSupport {
	...
	static {
		...
		addCaller(Vararg.class, new Caller() {
			@Override
			public <T> void call(Node node, AstVisitor<T> visitor, T param) {
				visitor.visitVararg((Vararg) node, param);
			}
		});
		...
		addCaller(InterfaceDeclaration.class, new Caller() {
			@Override
			public <T> void call(Node node, AstVisitor<T> visitor, T param) {
		...
		addCaller(ParamNode.class, new Caller() {
			@Override
			public <T> void call(Node node, AstVisitor<T> visitor, T param) {
				visitor.visitParam((ParamNode) node, param);
			}
		});
		addCaller(FieldNode.class, new Caller() {
			@Override
			public <T> void call(Node node, AstVisitor<T> visitor, T param) {
				visitor.visitFieldNode((FieldNode) node, param);
			}
		});
		addCaller(GenericType.class, new Caller() {
			@Override
			public <T> void call(Node node, AstVisitor<T> visitor, T param) {
				visitor.visitGenericType((GenericType) node, param);
			}
		});
	}
