...
public class MethodCallTemplates {
	private Map<String, VisitorContributor<MethodInvocationTree, List<AstNode>, GenerationContext>> templates =
			new HashMap<String, VisitorContributor<MethodInvocationTree, List<AstNode>, GenerationContext>>();
