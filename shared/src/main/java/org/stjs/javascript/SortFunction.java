...
public interface SortFunction<V> {
	 ...
	 * <em>S</em> if all of the requirements below are met for all values <em>a</em>, 
	 * <em>b</em>, and <em>c</em> (possibly the same value) in the set <em>S</em>: 
	 * 
	 * <ul>
	 * <li>Calling <tt>comparefn(a,b)</tt> always returns the same value <tt>v</tt> when given a 
